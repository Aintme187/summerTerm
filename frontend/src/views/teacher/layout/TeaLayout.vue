    ...
    <el-container>
      ...
      <el-aside width="200px" style="background-color: #F5F7FA;">
        ...
        <el-menu
          ...
          router
        >
          <el-menu-item index="/teacher/courseTable">
          ...
          <el-menu-item index="/teacher/memberManage">
            <el-icon><Promotion /></el-icon>
            <span>成员审批</span>
          </el-menu-item>
          <!--        <el-menu-item index="/teacher/assignmentManage">-->
          <!--          <el-icon><Promotion /></el-icon>-->
          <!--          <span>作业</span>-->
          <!--        </el-menu-item>-->
        </el-menu>
      ...
      <el-container style="height: 90vh;">
        ...
        <!-- <el-footer>教学模块 ©2024 Created by DdddM123 & Keith</el-footer> -->
      </el-container>
    </el-container>
  </el-container>
</template>
